...
sAppendN(&sbOut, "  \n", 3);
sAppendN(&sbOut, "  _llikNorm=(rxode2_llikNormFun) R_GetCCallable(\"rxode2ll\",\"rxLlikNorm\");\n", 74);
sAppendN(&sbOut, "  _llikNormDmean=(rxode2_llikNormFun) R_GetCCallable(\"rxode2ll\",\"rxLlikNormDmean\");\n", 84);
sAppendN(&sbOut, "  _llikNormDsd=(rxode2_llikNormFun) R_GetCCallable(\"rxode2ll\",\"rxLlikNormDsd\");\n", 80);
sAppendN(&sbOut, "  \n", 3);
sAppendN(&sbOut, "  _llikPois        = (rxode2_llikPoisFun) R_GetCCallable(\"rxode2ll\",\"rxLlikPois\");\n", 83);
sAppendN(&sbOut, "  _llikPoisDlambda = (rxode2_llikPoisFun) R_GetCCallable(\"rxode2ll\",\"rxLlikPoisDlambda\");\n", 90);
sAppendN(&sbOut, "  _llikBinom = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikBinom\");\n", 80);
sAppendN(&sbOut, "  _llikBinomDprob = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikBinomDprob\");\n", 90);
sAppendN(&sbOut, "  _llikNbinom = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikNbinom\");\n", 82);
sAppendN(&sbOut, "  _llikNbinomDprob = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikNbinomDprob\");\n", 92);
sAppendN(&sbOut, "  \n", 3);
sAppendN(&sbOut, "  _llikNbinomMu = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikNbinomMu\");\n", 86);
sAppendN(&sbOut, "  _llikNbinomMuDmu = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikNbinomMuDmu\");\n", 92);
sAppendN(&sbOut, "  _llikBeta = (rxode2_llikBetaFun)   R_GetCCallable(\"rxode2ll\", \"rxLlikBeta\");\n", 79);
sAppendN(&sbOut, "  _llikBetaDshape1 = (rxode2_llikBetaFun) R_GetCCallable(\"rxode2ll\", \"rxLlikBetaDshape1\");\n", 91);
sAppendN(&sbOut, "  _llikBetaDshape2 = (rxode2_llikBetaFun) R_GetCCallable(\"rxode2ll\", \"rxLlikBetaDshape2\");\n", 91);
sAppendN(&sbOut, "  _llikT = (rxode2_llikTFun)   R_GetCCallable(\"rxode2ll\", \"rxLlikT\");\n", 70);
sAppendN(&sbOut, "  _llikTDdf = (rxode2_llikTFun) R_GetCCallable(\"rxode2ll\", \"rxLlikTDdf\");\n", 74);
sAppendN(&sbOut, "  _llikTDmean = (rxode2_llikTFun) R_GetCCallable(\"rxode2ll\", \"rxLlikTDmean\");\n", 78);
sAppendN(&sbOut, "  _llikTDsd = (rxode2_llikTFun) R_GetCCallable(\"rxode2ll\", \"rxLlikTDsd\");\n", 74);
sAppendN(&sbOut, "  _llikChisq    = (rxode2_llikChisqFun) R_GetCCallable(\"rxode2ll\", \"rxLlikChisq\");\n", 83);
sAppendN(&sbOut, "  _llikChisqDdf = (rxode2_llikChisqFun) R_GetCCallable(\"rxode2ll\", \"rxLlikChisqDdf\");\n", 86);
sAppendN(&sbOut, "  _llikExp    = (rxode2_llikExpFun) R_GetCCallable(\"rxode2ll\", \"rxLlikExp\");\n", 77);
sAppendN(&sbOut, "  _llikExpDrate = (rxode2_llikExpFun) R_GetCCallable(\"rxode2ll\", \"rxLlikExpDrate\");\n", 84);
sAppendN(&sbOut, "  _llikF    = (rxode2_llikFFun) R_GetCCallable(\"rxode2ll\", \"rxLlikF\");\n", 71);
sAppendN(&sbOut, "  _llikFDdf1 = (rxode2_llikFFun) R_GetCCallable(\"rxode2ll\", \"rxLlikFDdf1\");\n", 76);
sAppendN(&sbOut, "  _llikFDdf2 = (rxode2_llikFFun) R_GetCCallable(\"rxode2ll\", \"rxLlikFDdf2\");\n", 76);
sAppendN(&sbOut, "  _llikGeom    = (rxode2_llikGeomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikGeom\");\n", 80);
sAppendN(&sbOut, "  _llikGeomDp  = (rxode2_llikGeomFun) R_GetCCallable(\"rxode2ll\", \"rxLlikGeomDp\");\n", 82);
sAppendN(&sbOut, "  _llikUnif        = (rxode2_llikUnifFun) R_GetCCallable(\"rxode2ll\", \"rxLlikUnif\");\n", 84);
sAppendN(&sbOut, "  _llikUnifDalpha  = (rxode2_llikUnifFun) R_GetCCallable(\"rxode2ll\", \"rxLlikUnifDalpha\");\n", 90);
sAppendN(&sbOut, "  _llikUnifDbeta   = (rxode2_llikUnifFun) R_GetCCallable(\"rxode2ll\", \"rxLlikUnifDbeta\");\n", 89);
sAppendN(&sbOut, "  _llikWeibull        = (rxode2_llikWeibullFun) R_GetCCallable(\"rxode2ll\", \"rxLlikWeibull\");\n", 93);
sAppendN(&sbOut, "  _llikWeibullDshape  = (rxode2_llikWeibullFun) R_GetCCallable(\"rxode2ll\", \"rxLlikWeibullDshape\");\n", 99);
sAppendN(&sbOut, "  _llikWeibullDscale   = (rxode2_llikWeibullFun) R_GetCCallable(\"rxode2ll\", \"rxLlikWeibullDscale\");\n", 100);
sAppendN(&sbOut, "  _llikGamma        = (rxode2_llikGammaFun) R_GetCCallable(\"rxode2ll\", \"rxLlikGamma\");\n", 87);
sAppendN(&sbOut, "  _llikGammaDshape  = (rxode2_llikGammaFun) R_GetCCallable(\"rxode2ll\", \"rxLlikGammaDshape\");\n", 93);
sAppendN(&sbOut, "  _llikGammaDrate   = (rxode2_llikGammaFun) R_GetCCallable(\"rxode2ll\", \"rxLlikGammaDrate\");\n", 92);
sAppendN(&sbOut, "  _llikCauchy        = (rxode2_llikCauchyFun) R_GetCCallable(\"rxode2ll\", \"rxLlikCauchy\");\n", 90);
sAppendN(&sbOut, "  _llikCauchyDlocation  = (rxode2_llikCauchyFun) R_GetCCallable(\"rxode2ll\", \"rxLlikCauchyDlocation\");\n", 102);
sAppendN(&sbOut, "  _llikCauchyDscale   = (rxode2_llikCauchyFun) R_GetCCallable(\"rxode2ll\", \"rxLlikCauchyDscale\");\n", 97);
