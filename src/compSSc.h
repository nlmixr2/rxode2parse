...
static inline void comp1ssInfCentral(int *central, double *yp, double *dur,
                                     double *ii, double *rate,
...
static inline void comp1ssInfDepot(double *yp, double *dur,
                                   double *ii, double *rate,
                                   double *ka, double *kel) {
...
static inline void comp2ssInfDepot(double *yp, double *dur, double *ii, double *rate,
...
static inline void comp2ssInfCentral(int *central,
                                     double *yp, double *dur, double *ii, double *rate,
                                     double *ka, double *k10, double *k12, double *k21) {
  // central infusion
  double E1 = (*k10)+(*k12);
  double E2 = (*k21);
  ...
  yp[*central]=(eT1*(E2*((eTi1*(rate[*central]) - eTi2*(rate[*central]))/(-L1 + L2) + (rate[*central])*E2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) - L1*((eTi1*(rate[*central]) - eTi2*(rate[*central]))/(-L1 + L2) + (rate[*central])*E2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) + (rate[*central])*(*k12)*(*k21)*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) - eT2*(E2*((eTi1*(rate[*central]) - eTi2*(rate[*central]))/(-L1 + L2) + (rate[*central])*E2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) - L2*((eTi1*(rate[*central]) - eTi2*(rate[*central]))/(-L1 + L2) + (rate[*central])*E2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) + (rate[*central])*(*k12)*(*k21)*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))))/(-L1 + L2);
  yp[*central+1]=(eT1*((*k12)*((eTi1*(rate[*central]) - eTi2*(rate[*central]))/(-L1 + L2) + (rate[*central])*E2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) + (rate[*central])*E1*(*k12)*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2)) - (rate[*central])*(*k12)*L1*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) - eT2*((*k12)*((eTi1*(rate[*central]) - eTi2*(rate[*central]))/(-L1 + L2) + (rate[*central])*E2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))) + (rate[*central])*E1*(*k12)*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2)) - (rate[*central])*(*k12)*L2*(1.0/(L1*L2) + eTi1/((L1 - L2)*L1) - eTi2/((L1 - L2)*L2))))/(-L1 + L2);
}
...
static inline void comp3ssInfDepot(double *yp, double *dur, double *ii, double *rate,
                                   double *ka, double *k10,
                                   double *k12, double *k21,
                                   double *k13, double *k31) {
...
static inline void comp3ssInfCentral(int *central, double *yp,
                                     double *dur, double *ii, double *rate,
                                     double *ka, double *k10,
                                     double *k12, double *k21,
                                     double *k13, double *k31) {
  // central infusion
