...
[![codecov.io](https://codecov.io/gh/nlmixr2/rxode2parse/coverage.svg)](https://codecov.io/gh/nlmixr2/rxode2parse)
...
ode solving and C compilation of models.  This can allow the rxode2 ui
to be in a R only package (which is easier to update and check).
